...
#Fargate profile also requires an attached role that lets the Fargate controller make calls to the AWS API 
...
resource "aws_iam_role_policy_attachment" "aws_eks_fargate_Pod_execution" {
...
#resource "aws_iam_policy"  "cluster_austoscaler_policy" {
...
#  policy_arn = "aws_iam_policy.cluster_austoscaler_policy.arn"
#  role       =  aws_iam_role.eks_worker_nodes.name
#
#}
